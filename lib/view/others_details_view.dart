...
class OthersDetailsView extends StatefulWidget {
  final GetCategoryProductModel item;
  const OthersDetailsView({super.key, required this.item});

  @override
  State<OthersDetailsView> createState() => _OthersDetailsViewState();
}

class _OthersDetailsViewState extends State<OthersDetailsView> {
                        ...
                        child: Row(
                          ...
                          children: [
                            Padding(
                              ...
                              child: Text(
                                contactProvider.companyProfile?.data?.phone
                                        ?.toString() ??
                                    "",
                                style: FontManager.headline.copyWith(
                                  color: Colors.green,
