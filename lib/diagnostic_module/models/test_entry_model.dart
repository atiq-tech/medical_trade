...
class TestEntryModel {
    ...
    factory TestEntryModel.fromMap(Map<String, dynamic> json) => TestEntryModel(
        ...
        specimen: Specimen.fromMap(json["specimen"]),
    );
...
class Specimen {
    ...
    factory Specimen.fromJson(String str) => Specimen.fromMap(json.decode(str));

    String toJson() => json.encode(toMap());

    factory Specimen.fromMap(Map<String, dynamic> json) => Specimen(
        id: json["id"],
