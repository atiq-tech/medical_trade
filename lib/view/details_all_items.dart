...
class DetailsAllItems extends StatefulWidget {
  final GetCategoryProductModel item;
  const DetailsAllItems({super.key, required this.item});

  @override
  State<DetailsAllItems> createState() => _DetailsAllItemsState();
}
class _DetailsAllItemsState extends State<DetailsAllItems> {
        ...
        child: Column(
          ...
          children: [
            ...
            child: (widget.item.images == null || widget.item.images!.isEmpty)
                ? Center(child: Text("No Images Available",style: TextStyle(fontSize: 16.sp, color: Colors.grey)))
                : CarouselSlider(
                ...
                children: List.generate(images.length, (index) {
                  return Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: provider.carouselIndex == index? const Color.fromRGBO(0, 0, 0, 0.9): const Color.fromRGBO(0, 0, 0, 0.4),
                    ),
                  );
                }),
              );
            ...
            Padding(
              ...
              child: Column(
                children: [
                            ...
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder: (context) => ImageZoomScreen(
                                  imageUrl:'https://app.medicaltradeltd.com/${widget.item.image}',
                                ),
                              ),
                            );
                          },
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                ...
                                style: FontManager.headline.copyWith(fontSize: 16.sp,fontWeight: FontWeight.w600),
                              ...
                              Row(
                                children: [
                                  Text(
                                    "Type :",
                                    textAlign: TextAlign.start,
                                    style: FontManager.headline.copyWith(color: Colors.black,fontSize: 14.sp,fontWeight: FontWeight.w600),
                                  ),
                                  SizedBox(width: 4.w),
                                  Text(
                  ...
                  Text("Description",style: FontManager.headline.copyWith(fontSize: 18.sp,fontWeight: FontWeight.bold)),
                  SizedBox(height: 4.h),
                    ...
                    children: [
                      Container(
                        decoration: BoxDecoration(
                          ...
                          boxShadow: [
                            BoxShadow(color: Colors.black26,offset: Offset(0, 2),blurRadius: 6.r),
                          ],
                        ),
                        child: Row(
                          mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
                           ...
                           InkWell(
                              ...
                              child: Padding(
                                padding:EdgeInsets.only(left: 12.w, right: 12.w),
                                child: Icon(Icons.call,size: 22.sp,color: Colors.green),
                              ),
                            ),
                          ],
                        ),
                  ...
                  InkWell(
                    onTap: () {
                      showDialog(
                        ...
                        builder: (context) {
                          ...
                          final provider = Provider.of<CustomerProductBuyApi>(context,listen: false);
                          return AlertDialog(
                                ...
                                children: [
                                  TextButton(
                                    ...
                                    child: Container(
                                      ...
                                      child: Center(child: Text("Cancel",style: TextStyle(color: Colors.white,fontSize: 14.sp)),
                                      ),
                                    ),
                                  ),
                                        ...
                                        onPressed: provider.isLoading? null
                                         : () {
                                            showDialog(
                                              ...
                                              builder: (context) {
                                                return Center(child: SpinKitCircle(color: Colors.red,size: 50.0.sp));
                                              },
                                            );
                                            provider.fetchCustomerCodeAndSendOrder(wallpostId: widget.item.id.toString(),
                                            ).then((_) {
                                              Navigator.pop(context); 
                                              Navigator.pop(context); 
                                              if (provider.errorMessage == null) {
                                                CustomToast.show(context: context,text:"Order completed successfully",isSuccess: true);
                                              } else {
                                                CustomToast.show(context: context,text: provider.errorMessage ?? "An error occurred",isSuccess: false);
                                              }
                                            }).catchError((error) {
                                              Navigator.pop(context); 
                                              CustomToast.show(context: context,text: "Error: $error",isSuccess: false);
                                            });
                                          },
                                        child: Container(
                                          height: 35.h,
                                          ...
                                          child: Center(child: Text("Confirm Order",style: TextStyle(color: Colors.white,fontSize: 12.sp)),
                                          ),
                                        ),
                                      );
                                    },
                    ...
                    child: Card(
                      ...
                      child: Container(
                        ...
                        child: Center(
                          child: Text("Order Now",style: FontManager.bodyText.copyWith(color: ColorManager.white,fontSize: 14.sp)),
                        ),
                      ),
                    ),
                  ),
