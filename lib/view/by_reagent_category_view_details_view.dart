...
class ByReagentCategoryViewDetailsView extends StatefulWidget {
  final GetCategoryProductModel item;
  const ByReagentCategoryViewDetailsView({super.key, required this.item});

  @override
  State<ByReagentCategoryViewDetailsView> createState() =>
      _ByReagentCategoryViewDetailsViewState();
}

class _ByReagentCategoryViewDetailsViewState
    extends State<ByReagentCategoryViewDetailsView> {
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Column(
                            ...
                            children: [
                              Text(
                                widget.item.productCategoryName.toString(),
