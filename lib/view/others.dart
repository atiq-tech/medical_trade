        ...
        title: _isSearching
          ...
          child: TypeAheadField<GetCategoryProductModel>(
            ...
            onSelected: (GetCategoryProductModel suggestion) {
              ...
              Navigator.push(context,MaterialPageRoute(builder: (context) =>OthersDetailsView(item: suggestion)));
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: InkWell(
                                onTap: () {
                                  Navigator.push(context, MaterialPageRoute(builder: (context) =>OthersDetailsView(item: product)));
                                },
                                child: Card(
                                  elevation: 5,
                                  child: Container(
