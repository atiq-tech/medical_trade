...
class ImageAssets {
  ...
  static const String diagModule = "$imagePath/diagModule.png";
  static const String regalSupport = "$imagePath/regal support.png";
  static const String diagnostic = "$imagePath/diagnostic.png";
...
class DiagnosticModule {
  static const String patient = "$imagePath/pentry.png";
  static const String patientList = "$imagePath/plist.png";
  static const String doctor = "$imagePath/doctor.png";
  static const String doctorList = "$imagePath/doctorlist.png";
  static const String testEntry = "$imagePath/tentry.png";
