...
class MyWallProductsDetails extends StatefulWidget {
  ...
  @override
  State<MyWallProductsDetails> createState() => _MyWallProductsDetailsState();
}

class _MyWallProductsDetailsState extends State<MyWallProductsDetails> {
...
//             onTap: () => _openZoomView(context),
//             child: (widget.item.images == null || widget.item.images!.isEmpty)
//                 ? Center(child: Text("No Images Available",style: TextStyle(fontSize: 16, color: Colors.grey)))
//                 : CarouselSlider(
//                     items: widget.item.images!.map((item) {
//                       return Builder(
//                         builder: (BuildContext context) {
...
//                  SizedBox(height: 16.h),
//                   Text("Description",
//                     style: FontManager.headline.copyWith(fontSize: 18.sp,fontWeight: FontWeight.bold),
//                   ),
//                   SizedBox(height: 4.h),
...
//                         builder: (context) {
//                           // ignore: unused_local_variable
//                           final provider =Provider.of<ClientWallProductBuyProvider>(context,listen: false);
//                           return AlertDialog(
//                             shape: RoundedRectangleBorder(
//                               borderRadius: BorderRadius.circular(8.r),
//                             ),
...
//               Padding(
//                 padding: EdgeInsets.only(top: 10.h),
//                 child: IconButton(icon: Icon(Icons.close,color: Colors.white,size: 30.sp),
//                   onPressed: () => Navigator.of(context).pop(),
//                 ),
//               ),
//             ],
...
//               String imagePath = widget.item.images![index];
//               return PhotoViewGalleryPageOptions(
//                 imageProvider: NetworkImage('https://app.medicaltradeltd.com/$imagePath'),
//                 minScale: PhotoViewComputedScale.contained,
//                 maxScale: PhotoViewComputedScale.covered * 2,
//                 heroAttributes: PhotoViewHeroAttributes(tag: 'gallery_$index'),
//               );
